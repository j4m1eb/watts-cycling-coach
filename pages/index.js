  ...
  return (
    <div style={styles.overviewGrid}>
      ...
      <div style={{ ...styles.card, borderColor: '#00d4aa40' }}>
        ...
        <div style={{ fontFamily: 'JetBrains Mono', fontSize: 34, color: '#00d4aa', marginBottom: 8 }}>
          {daysUntilCalpe()} days
        </div>
...
function Metric({ label, value, unit, color }) {
  return (
    <div style={{ textAlign: 'center' }}>
      <div style={{ fontFamily: 'JetBrains Mono', fontSize: 34, fontWeight: 500, color: color || '#e6e6ea' }}>
        {value}{unit}
      </div>
...
function ActStat({ label, value }) {
  return (
    <div style={{ textAlign: 'center', background: '#1e1e24', borderRadius: 6, padding: '8px 12px' }}>
      <div style={{ fontFamily: 'JetBrains Mono', fontSize: 34, color: '#e6e6ea' }}>{value}</div>
...
function Loader() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 300, flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ fontFamily: 'JetBrains Mono', fontSize: 16, color: '#6b6b7a', letterSpacing: '2px' }}>LOADING INTERVALS.ICU DATA</div>
...
const styles = {
  ...
  logoText: { fontFamily: 'Inter', fontSize: 34, letterSpacing: 4, color: '#00d4aa', lineHeight: 1 },
  logoSub: { fontFamily: 'JetBrains Mono', fontSize: 16, letterSpacing: 2, color: '#6b6b7a', marginTop: 3 },
  ...
  raceLabel: { fontFamily: 'JetBrains Mono', fontSize: 16, letterSpacing: 2, color: '#6b6b7a', marginBottom: 4 },
  ...
  pageTitle: { fontFamily: 'Inter', fontSize: 24, letterSpacing: 2, color: '#e6e6ea' },
  ...
  cardLabel: {
    fontFamily: 'JetBrains Mono', fontSize: 16, letterSpacing: 2,
    color: '#6b6b7a', marginBottom: 12, textTransform: 'uppercase',
  },

  bigNumber: { fontFamily: 'Inter', fontSize: 48, letterSpacing: 2, marginBottom: 16 },

  tsbRow: { display: 'flex', gap: 32, marginBottom: 8 },
  formRisk: { fontSize: 16, color: '#ff7a00', marginTop: 4, fontFamily: 'JetBrains Mono' },

  actName: { fontSize: 34, fontWeight: 500, color: '#e6e6ea', marginBottom: 4 },
  actMeta: { fontSize: 16, color: '#6b6b7a', marginBottom: 12, fontFamily: 'JetBrains Mono' },
